...
const PromotionModalCommentsTree = ({ comments, sendComment }) => {
    const tree = useMemo(() => getTree(comments), [comments]);   //Use memo funciona como Cache e trabalha como useEffect. Ele só vai executar qnd o comments mudar
    ...
    function renderList(list){
        return(
            <ul className="promotion-modal-comments-tree">
                ...
                {// Pode ser escrito como {list.map(renderItem) pois o item é usado como parametro nas duas funções
    }
            </ul>
